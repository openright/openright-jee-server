...
/**
 * @see "http://stackoverflow.com/questions/3732109/simple-http-server-in-java-using-only-java-se-api/20261540#20261540"
 */
@SuppressWarnings("deprecation")
final class SimpleHttpServletWebServer {
	HttpServer server;
	private String contextPath;
	private HttpHandler httpHandler;

	public SimpleHttpServletWebServer(String contextPath, HttpServlet servlet) {
...
final class HttpHandlerWithServletSupport implements HttpHandler {
	...
	public void handle(final HttpExchange ex) throws IOException {
		...
		try {
			parsePostData.putAll(HttpUtils.parseQueryString(ex.getRequestURI()
					.getQuery()));
